(function () {
    let MenuTpl =
        ...
        '<div class="menu">' +
        '<div class="head"><span class="menu-title">{{{title}}}</span></div>' +
        '<div class="menu-items">' +
        "{{#elements}}" +
        '<div class="menu-item {{#selected}}selected{{/selected}} {{#checkbox}}checkbox-item{{/checkbox}}">' +
        '<div class="menu-item-label">{{{label}}}</div>' +
        '{{#checkbox}}<div class="menu-checkbox {{#checked}}checked{{/checked}}"></div>{{/checkbox}}' +
        "</div>" +
        "{{/elements}}" +
        "</div>" +
        "</div>" +
